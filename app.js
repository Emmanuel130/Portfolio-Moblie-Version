...
const projectsList = [
  {
    ...
    company: 'Camara',
    year: '2022',
    sourceLink: 'https://github.com/Emmanuel130/Portfolio-Moblie-Version',
    demoLink: 'https://emmanuel130.github.io/Portfolio-Moblie-Version/',
  },
  ...
  workSection.innerHTML += `
    <div class="card">
      ...
      <div class="card-content">
          ...
          <ul class="triple">
              <li class="camara">${projectsList[i].company}</li>
